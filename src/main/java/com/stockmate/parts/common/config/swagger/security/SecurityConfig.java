...
import com.stockmate.parts.common.config.swagger.filter.JwtHeaderFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers(
                                "/api/v1/parts/health-check", "/api/v1/parts/check", "/api/v1/parts/detail",
                                "/api/v1/store/inventory/update", "/api/v1/parts/deduct-stock", "/api/v1/parts/**"
                        ).permitAll()
